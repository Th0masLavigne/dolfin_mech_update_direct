...
mat_params = {"alpha": 0.16, "gamma": 0.5, "c1": 0.6, "c2": 0.0, "kappa": 1e2, "eta": 1e-5}
...
while error > 1e-2:
	U_loaded_to_unloaded, Phis0_unloaded, dV_loaded = dmech.runs.RivlinCube_PoroHyperelasticity(
		dim=dim,
		inverse=1,
	...
	U_unloaded_to_loaded, phis_loaded, dV_unloaded = dmech.runs.RivlinCube_PoroHyperelasticity(
		dim=dim,
		inverse=0,
		cube_params={"l": 0.1, "mesh_filebasename": res_folder + "/" + "mesh"},
...
U_loaded_to_unloaded_GenPoro, phis_loaded_GenPoro, dV_exhal_GenPoro = dmech.runs.RivlinCube_PoroHyperelasticity(
	dim=dim,
	inverse=1,
	cube_params={"l": 0.1, "mesh_filebasename": res_folder + "/" + "mesh"},
